...
function demoBadge(){
  ...
  if (d && d.live) return '<span class="chip tag-live">'+esc(t('liveData'))+'</span>';
  return '<span class="chip" style="color:var(--fg-2);border-color:var(--line-soft);background:var(--panel-2)">'+esc(t('demoData'))+'</span>';
}
